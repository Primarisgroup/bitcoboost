...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs) || gArgs.IsArgSet("-version")) {
        ...
        if (gArgs.IsArgSet("-version")) {
            ...
            strUsage += "\n"
                "Usage:  bitcoboost-tx [options] <hex-tx> [commands]  Update hex-encoded BitcoBoost transaction\n"
                "or:     bitcoboost-tx [options] -create [commands]   Create hex-encoded BitcoBoost transaction\n"
                "\n";

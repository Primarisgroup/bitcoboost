...
public:
    ...
    virtual bool CheckHybridSignature(const std::vector<unsigned char>& ecdsa_sig, const std::vector<unsigned char>& ecdsa_pub, const std::vector<unsigned char>& mldsa_sig, const std::vector<unsigned char>& mldsa_pub, const std::vector<unsigned char>& program) const
    {
        return false;
    }
...
public:
    ...
    bool CheckHybridSignature(const std::vector<unsigned char>& ecdsa_sig, const std::vector<unsigned char>& ecdsa_pub, const std::vector<unsigned char>& mldsa_sig, const std::vector<unsigned char>& mldsa_pub, const std::vector<unsigned char>& program) const override;
...
public:
    ...
    bool CheckHybridSignature(const std::vector<unsigned char>& ecdsa_sig, const std::vector<unsigned char>& ecdsa_pub, const std::vector<unsigned char>& mldsa_sig, const std::vector<unsigned char>& mldsa_pub, const std::vector<unsigned char>& program) const override
    {
        return m_checker.CheckHybridSignature(ecdsa_sig, ecdsa_pub, mldsa_sig, mldsa_pub, program);
    }

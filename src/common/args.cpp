...
const char * const BITCOIN_CONF_FILENAME = "bitcoboost.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitcoBoost";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/BitcoBoost";
#else
    // Unix-like
    return pathRet / ".bitcoboost";
#endif
#endif
}

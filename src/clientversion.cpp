// Copyright (c) 2012-2022 The Bitcoboost developers
 ...
 */
const std::string CLIENT_NAME("BitcoBoost");
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Bitcoboost") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Bitcoboost developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://bitcoboost.org/>";
